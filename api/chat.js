...
// Support-Chat: gemini-2.0-flash as primary (stable v2, replaces deprecated 1.5 models)
const MODELS = ['gemini-2.0-flash', 'gemini-2.5-flash', 'gemini-2.5-flash-lite', 'gemini-1.5-flash-002'];
