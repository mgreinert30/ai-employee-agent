...
• Format: ✅ Ja, weil... / ❌ Nein, weil... / ⚠️ Kommt darauf an, weil... — gefolgt von 3-5 konkreten Gründen.
• Bei KURZ-Analyse: NUR diese Direktantwort + kompakte Fakten. Keine Struktur-Blöcke nötig.
...
• Format: ✅ Yes, because... / ❌ No, because... / ⚠️ It depends, because... — followed by 3-5 concrete reasons.
• For SHORT analysis: ONLY this direct answer + compact key facts. No structural blocks needed.
...
function initScrollReveal() {
  ...
  const groups = [
    ...
    { sel: '.cost-compare-section .section-chip',    delay: 0   },
    { sel: '.cost-compare-section h2',               delay: 80  },
    { sel: '.cost-compare-sub',                      delay: 160 },
    { sel: '.cost-col',                              delay: 80,  stagger: 150 },
    { sel: '.character-section .section-chip',       delay: 0   },
    { sel: '.character-section h2',                  delay: 80  },
    { sel: '.character-section > p',                 delay: 160 },
    { sel: '.character-card',                        delay: 100, stagger: 130 },
    { sel: '.faq-inner .section-chip',               delay: 0   },
    { sel: '.faq-inner h2',                          delay: 80  },
    { sel: '.faq-item',                              delay: 40,  stagger: 60  },
...
(function initNavHighlight() {
  if (typeof IntersectionObserver === 'undefined') return;
  const targets = ['nav-start','nav-demo','mini-spiel','nav-funktionen','nav-preise','nav-faq','nav-kontakt'];
  const hrefs   = ['#nav-start','#nav-demo','#mini-spiel','#nav-funktionen','#nav-preise','#nav-faq','#nav-kontakt'];
  let activeIdx = 0;
